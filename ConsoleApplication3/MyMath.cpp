...
double MyMath::floor(double x) { return std::floor(x); }

double MyMath::max(double x, double y) { return std::max(x,y); }

double MyMath::min(double x, double y) { return std::min(x,y); }

double MyMath::pow(double x, int y) { return std::pow(x,y); }
